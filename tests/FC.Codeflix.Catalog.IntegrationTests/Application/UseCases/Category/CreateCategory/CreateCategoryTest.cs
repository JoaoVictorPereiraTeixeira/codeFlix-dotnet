...
using ApplicationUseCase = FC.Codeflix.Catalog.Application.UseCases.Category.CreateCategory;
using Xunit;
...
public class CreateCategoryTest
{
    ...
    public async void CreateCategory()
    {
        ...
        var useCase = new ApplicationUseCase.CreateCategory(repository, unitOfWorkMock);
